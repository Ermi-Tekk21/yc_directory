...
// Query: *[_type == "startup" && (!defined($search) || title match $search)] {  _id,  _type,  _createdAt,  _updatedAt,  _rev,  title,  slug,  author-> {    _id,    name,    image,    bio  },  views,  description,  category,  image,  pitch}
